...
class Controller_User extends Controller_Mycontroller
{
    ...
    public function action_mypage()
    {
        ...
        if (!empty($this->user_info['hobbies'])) {
            $this->user_info['hobbies'] = Mymodel::getHobbiesName($this->user_info['hobbies']);
        }
    ...
    public function action_user_info_edit()
    {
        ...
        if (Input::method() == 'POST') {
            ...
            if ($val->run()) {
                ...
                if (Mymodel::editUserInfo($this->user_id, $user, $hobbies)) {
                    $data['user_info'] = Mymodel::getUserInfo($this->user_id);
                } else {
